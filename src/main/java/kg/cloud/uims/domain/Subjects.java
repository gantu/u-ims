...
public class Subjects implements Serializable{
    ...
    public Subjects(int i,String sbjN, String sbjH,String cd,String deptC, String deptN,
            String stdyr,String sem,String crdt, int status) {
        this.id = i;
        this.subjName = sbjN;
        this.subjHrs = sbjH;
        this.code = cd;
    ...
    public Subjects(int i,String sbjN, String sbjH,String cd,String deptC, String deptN,
            String stdyr,String sem,String crdt, String subjInstID, int status) {
        this.id = i;
