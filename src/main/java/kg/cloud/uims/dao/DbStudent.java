...
public class DbStudent extends BaseDb {
	...
	public void execSQL_GR(String gr_id) throws SQLException {
		...
		while (result.next()) {
			q.add(new Student(result.getInt("t1.id"), result
					.getString("t1.name"), result.getString("t1.surname"),
					result.getString("t1.rollnum"), result
							.getString("t1.edu_order_number1"), result
							.getString("t1.awards"), result
							.getString("t1.attestat"), result
							.getString("t1.permadr"), result
							.getString("t1.curradr"), result
							.getString("t1.birthpl"), result
							.getString("t1.phone"), result
							.getDate("t1.birth_date"), result
							.getString("t1.passport"), result
							.getString("t1.email"), result
							.getString("t1.photo"), result
							.getString("t1.mother_name"), result
							.getString("t1.mother_surname"), result
							.getString("t1.mother_workpl"), result
							.getString("t1.mother_phone"), result
							.getString("t1.father_name"), result
							.getString("t1.father_surname"), result
							.getString("t1.father_workpl"), result
							.getString("t1.father_phone"), result
							.getString("t1.note_1"), result
							.getString("t1.note_2"), result
							.getString("t1.note_3"), result
							.getString("t1.note_4"), result
							.getString("t2.name"), result.getString("t3.name"),
					...
					result.getString("t15.nationality"), result
							.getString("t16.code"), result
							.getString("t17.user_pass"), result
							.getString("t1.grad_project"), result
							.getString("t17.status"), result
							.getString("t1.edu_order_number2"), result
							.getString("t1.edu_order_number3"), result
							.getString("t18.status")));
		}
	}
		...
		while (result.next()) {
			q.add(new Student(result.getInt("t1.id"), result
					...
					result.getString("t15.nationality"), result
							...
							.getString("t17.status"), result
							.getString("t1.edu_order_number2"), result
							.getString("t1.edu_order_number3")));
		}
	}
	...
	public void execFaculty(String sid) throws SQLException {
		...
		ResultSet result = stat.executeQuery();
		while (result.next()) {
			q.add(new Student(result.getString("name"), result
					.getString("t1.rollnum"), result.getString("t4.name"),
