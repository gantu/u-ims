...
public class DbStudent extends BaseDb {
    ...
    public void execSQL_GR(String gr_id) throws SQLException {
        ...
        while (result.next()) {
            q.add(new Student(result.getInt("t1.id"), result.getString("t1.name"), result.getString("t1.surname"),
                    result.getString("t1.rollnum"), result.getString("t1.edu_order_number1"), result.getString("t1.awards"), result.getString("t1.attestat"), result.getString("t1.permadr"), result.getString("t1.curradr"), result.getString("t1.birthpl"), result.getString("t1.phone"), result.getDate("t1.birth_date"), result.getString("t1.passport"), result.getString("t1.email"), result.getString("t1.photo"), result.getString("t1.mother_name"), result.getString("t1.mother_surname"), result.getString("t1.mother_workpl"), result.getString("t1.mother_phone"), result.getString("t1.father_name"), result.getString("t1.father_surname"), result.getString("t1.father_workpl"), result.getString("t1.father_phone"), result.getString("t1.note_1"), result.getString("t1.note_2"), result.getString("t1.note_3"), result.getString("t1.note_4"), result.getString("t2.name"), result.getString("t3.name"),
                    result.getString("t3.code"), result.getString("t4.name"),
                    result.getString("t5.name"), result.getString("t6.name"),
                    result.getString("t7.name"), result.getString("t8.year"),
                    result.getString("t9.name"), result.getString("t10.name"),
                    result.getString("t11.name"), result.getString("t12.name"),
                    result.getString("t13.name"), result.getString("t14.code"),
                    result.getString("t15.nationality"), result.getString("t16.code"), result.getString("t17.user_pass"), result.getString("t1.grad_project"), result.getString("t17.status"), result.getString("t1.edu_order_number2"), result.getString("t1.edu_order_number3"), result.getString("t18.status")));
        }
    }

    public void execSQL_GR_forRegistr(String gr_id)
            throws SQLException {

        String sql = "select t1.id, t1.name, t1.surname, t5.name"
                + " from student as t1"
                + " left join education as t5 on t1.edu_status_id=t5.id"                
                + " where t1.group_id=? and (t1.edu_status_id=1 or t1.edu_status_id=3 or t1.edu_status_id=5)"
        ...
        ResultSet result = stat.executeQuery();
        while (result.next()) {
            q.add(new Student(result.getInt("t1.id"), result.getString("t1.name"),
                    result.getString("t1.surname"), result.getString("t5.name")));
        }
    }
    ...
    public void execSQL_GR_Active(String gr_id) throws SQLException {
        ...
        while (result.next()) {
            q.add(new Student(result.getInt("t1.id"), result.getString("t1.name"), result.getString("t1.surname"),
                    ...
                    result.getString("t11.name"), result.getString("t12.name"),
                    result.getString("t13.name"), result.getString("t14.code"),
                    result.getString("t15.nationality"), result.getString("t16.code"), result.getString("t17.user_pass"), result.getString("t1.grad_project"), result.getString("t17.status"), result.getString("t1.edu_order_number2"), result.getString("t1.edu_order_number3")));
        }
    }
    ...
    public void execFaculty(String sid) throws SQLException {

        String sql = "select concat(t1.name,' ',t1.surname)as name,t1.rollnum, t4.name, t3.name"
                + " from student as t1"
                + " left join department as t3 on t1.dept_id=t3.id"
        ...
        ResultSet result = stat.executeQuery();
        while (result.next()) {
            q.add(new Student(result.getString("name"), result.getString("t1.rollnum"), result.getString("t4.name"),
