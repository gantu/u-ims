...
public class DbInstructor extends BaseDb {
	...
	public void execSQL() throws SQLException {
		...
		while (result.next()) {
			q.add(new Instructor(result.getInt("t1.id"), result
					...
					result.getString("t4.name"), result.getString("t5.name"),
					result.getString("t6.name"), result.getString("t1.phone"),
					result.getString("t1.permadr"), result
							.getString("t1.curradr"), result
							.getString("t1.birthpl"), result
							.getString("t7.code"), result
							.getString("t8.nationality"), result
							.getString("t9.code"), result
							.getDate("t1.birth_date"), result
							.getString("t1.passport"), result
							.getString("t1.email"), result
							.getString("t1.photo"), result
							.getString("t10.code"), result
							.getString("t11.code"), result
							.getString("t12.name"), result
							.getString("t13.user_pass"), result
							.getString("t14.role_name"), result
							.getString("t13.status"), result.getInt("t10.id"),
					result.getInt("t11.id"), result.getInt("t12.id")));
		}
	}
	...
	public Instructor execSQLRN(String instRollnum) throws SQLException {
		...
		ResultSet result = stat.executeQuery();
		while (result.next()) {
			instructor = new Instructor(result.getInt("t1.id"),
					...
					result.getString("t4.name"), result.getString("t5.name"),
					result.getString("t6.name"), result.getString("t1.phone"),
					result.getString("t1.permadr"),
					result.getString("t1.curradr"),
					result.getString("t1.birthpl"),
					result.getString("t7.code"),
					result.getString("t8.nationality"),
					result.getString("t9.code"),
					result.getDate("t1.birth_date"),
					result.getString("t1.passport"),
					result.getString("t1.email"), result.getString("t1.photo"),
					result.getString("t10.code"), result.getString("t11.code"),
					result.getString("t12.name"),
					result.getString("t13.user_pass"),
					result.getString("t14.role_name"),
					result.getString("t13.status"), result.getInt("t10.id"),
					result.getInt("t11.id"), result.getInt("t12.id"));
		}
		return instructor;
	}
	...
	public void execSQL_byRole(String instRollnum) throws SQLException {
		String sql = "select t1.id,t1.name,t1.surname,t2.name,t3.name,t1.rollnum,t4.name, t5.name,t6.name,"
				+ " t1.phone, t1.permadr, t1.curradr,t1.birthpl, t7.code,t8.nationality, t9.code,t1.birth_date,"
				+ " t1.passport,t1.email, t1.photo, t10.id, t10.code, t11.id, t11.code, t12.id, t12.name, t13.user_pass, t13.status, t14.role_name"
				+ " from instructor as t1"
		...
		ResultSet result = stat.executeQuery();
		while (result.next()) {
			q.add(new Instructor(result.getInt("t1.id"),
					result.getString("t1.name"),
					result.getString("t1.surname"),
					result.getString("t2.name"), result.getString("t3.name"),
					result.getString("t1.rollnum"),
