...
public class AuthenticatedScreen extends VerticalLayout{
	...
	public AuthenticatedScreen(MyVaadinApplication app)
    {
        ...
        try {
            ...
            Logger.getLogger(AuthenticatedScreen.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        Subject currentUser = SecurityUtils.getSubject();
        Label label = new Label("<b>Logged in as </b> <i>" +  currentUser.getPrincipal().toString()+"</i><br/>"
                + "<b>Current Semester: </b><i>"+app.getCurrentSemester().toString()+"</i>");
