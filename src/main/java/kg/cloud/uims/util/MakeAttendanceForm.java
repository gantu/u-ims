			...
			public InputStream getStream() {
				...
				try {
		            ...
		            if (!studLessList.isEmpty()) {
		                ...
		                Thead.addCell(new Phrase(studLessList.get(0).getSubjName(), text_font));
		                ...
		                for (int i = 0; i < studLessList.size(); i++) {
		                    ...
		                    Tbody.addCell(new Phrase(studLessList.get(i).getStudName() + " " + studLessList.get(i).getStudSurname(), text_font));
		                    Tbody.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
